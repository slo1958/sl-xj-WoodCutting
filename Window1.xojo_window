...
Begin DesktopWindow Window1
   ...
   Begin DesktopLabel Label1
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Length of one source item"
      TextAlignment   =   0
      TextColor       =   &c000000
      Tooltip         =   ""
      Top             =   20
      ...
      Width           =   184
   End
   Begin DesktopTextField tf_inWoodLength
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
   ...
   Begin DesktopLabel Label3
      ...
      Width           =   184
   End
   Begin DesktopTextField tf_nbUsed
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin DesktopLabel Label4
      ...
      Width           =   200
   End
   Begin DesktopTextField tf_leftOver
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin DesktopLabel Label6
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Nbr leftovers out of used items"
      TextAlignment   =   0
      TextColor       =   &c000000
      Tooltip         =   ""
      Top             =   329
      ...
      Width           =   193
   End
   Begin DesktopTextField tf_nbLeftOver
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin DesktopLabel Label7
      ...
      Width           =   100
   End
   Begin DesktopTextField tf_in_MeasureMargin
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin DesktopLabel Label9
      ...
      Width           =   100
   End
   Begin DesktopTextField tf_nbUnallocated
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin DesktopLabel Label10
      ...
      Width           =   184
   End
   Begin DesktopTextField tf_inLeftoverMinLength
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin DesktopLabel Label12
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Max number of source items"
      TextAlignment   =   0
      TextColor       =   &c000000
      Tooltip         =   ""
      Top             =   121
      ...
      Width           =   184
   End
   Begin DesktopTextField tf_InMaxItems
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub RunModel(partLength as integer, cutmargin as integer, usefullLeftover as integer, maxItems as integer, measureMargin as integer)
		  ...
		  var wrl as new clWorld
		  
		  wrl.SetWriter(AddressOf WriteMessage)
		  
		  // Load the requirements in the model
		  wrl.PrepareWoodParts(req, "LABEL","VALUE", measureMargin)
		  
		  // Configure the model
		  wrl.WoodSourceLengtrh = partLength
	...
	#tag Method, Flags = &h0
		Sub WriteMessage(MsgType as string, MsgText as string)
		  //ListBox1.ColumnCount = 2
		  
		  listbox1.AddRow(MsgText)
...
#tag Events Button5
	#tag Event
		Sub Pressed()
		  ...
		  var woodLength as integer = tf_inWoodLength.Text.ToInteger
		  var measureMargin as integer = tf_in_MeasureMargin.Text.ToInteger
		  var usefullLeftOverMinLength as integer = tf_inLeftoverMinLength.Text.ToInteger
		  var maxItems as integer = tf_InMaxItems.Text.ToInteger
