...
- The input file is expected to contain: 
	- a column named ‘cell label’, that is renamed to ‘label’, comment the line renaming the columns as needed
	- a column named ‘cell value’ that is converted to integer, named ‘Value’
